...
function load_everything(err, worldTopo, all_countries, transmission_lines, other_transmission_lines) {
  ...
  setup_project_countries(all_countries, function() {
    ...
    loadWorld(worldTopo, all_countries);
...
queue(4)
  .defer(d3.json, './data/world_topography.json')
